...
<head>
  ...
  <script src="https://kit.fontawesome.com/ebd8283d0b.js" crossorigin="anonymous"></script>
...
<body>
  <header class="">
      ...
      <div class="container-fluid">
        <div class="row d-flex justify-content-between align-items-center">
          ...
          <div class="header-info-left d-flex">
            <img src="images1/india.jpg" id="flag-icon" alt="flag" height="20px" width="25px">
            <form action="#">
              <select name="select" id="nation-select" aria-labelledby="select-box">
          ...
          <div class="search-box" role='search' id="search-box">
            <input type="search" name="searchbox" role="form" id="searchbox" placeholder="Search Products and Brands"
    ...
    <div class="header-bottom" id="header-sticky">
      <div class="container-fluid">
        <div class="row align-items-center d-flex sticky-bar-wrapper sticky-shadow sticky">

          <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
            <a href="index.html"><img src="images/logo.png" alt="logo"></a>
          </div>
          <div class="input-group d-xl-none d-lg-none" id="search-box-container">
            <input type="search" id="search-box-hidden" class="" placeholder="Search products and Brands"
              aria-label="search box" aria-describedby="basic-addon1">
            <i class="fa fa-search"></i>
          </div>
          ...
          <div class="col-xl-5 col-lg-3 col-md-3 col-sm-3">
            <ul class="header-right f-right d-none d-lg-block d-flex justify-content-between">
              ...
              <li><button class="btn" id="signin" type="button" data-toggle="modal" data-target="#exampleModal"
                  aria-labelledby='sign-in-btn'>Sign in</button></li>
            </ul>
          </div>
      ...
      <!-- modal-content -->
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-label="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
              ...
              <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                  <a href="#create-account" id="tab2" class='nav-link' style="border-color: white;"
                    aria-controls="create-account" aria-selected='false' role="tab" tabindex=0 data-toggle='tab'>CREATE
                    ACCOUNT</a>
                </li>
              </ul>
                ...
                <div class="tab-pane active" id="login" role="tabpanel" aria-labelledby="tab1" aria-hidden='false'>
                  ...
                  <form class="d-flex flex-column">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" role="email"
                    ...
                    <button type="submit" class="btn btn-orange rounded-0">SIGN
                      IN</button><br>
                    <button type="submit" class="btn btn-default2 rounded-0" id="forgotbtn">FORGOT YOUR
                      PASSWORD?</button>
                  </form>
                </div>
                <div class="tab-pane" id="create-account" role="tabpanel" aria-labelledby="tab2" aria-hidden='true'>
                  ...
                  <form class="d-flex flex-column">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail2" role="email"
                        placeholder="Enter email">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer d-flex flex-column justify-items-center">
              ...
              <div class="modal-social-btn d-flex">
                <a class="btn text-white" style="background-color: #3b5998" href="#!" role="button"><span
                    class="bi bi-facebook">facebook</span></a>
                <a class="btn text-white" style="background-color: #55acee" href="#!" role="button"><span
                    class="bi bi-twitter">twitter</span></a>
                <a class="btn text-white" style="background-color: #dd4b39" href="#!" role="button"><span
  ...
  <main>
          ...
          <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="images1/mainimg.jpg" alt="mainimg" height="450px" width="399px">
              </div>
              <div class="carousel-item ">
                <img class="d-block w-100" src="images1/view2.jpg" alt="mainimg" height="450px" width="399px">
              </div>
              <div class="carousel-item ">
                <img class="d-block w-100" src="images1/Offer.jpg" alt="mainimg" height="450px" width="399px">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-content" id="nav-Content">
          ...
          <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="row products">
              ...
              <div class="col-xl-4 col-lg-4 col-md-6" id="nav-contact">
                <div class="single-product mb-60">
                  <div class="product-img">
                    <img src="images/product6.png" alt="">
                    <div class="new-product bg-danger">
          ...
          <div class="tab-pane fade show active" id="nav-last" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="row products">

              <div class="col-xl-4 col-lg-4 col-md-6" id="nav-last">
                <div class="single-product mb-60">
                  <div class="product-img">
                    <img src="images/product4.png" alt="">
                    <div class="new-product bg-danger">
    ...
    <div class="container">
      <div class="row mt-5 mb-5">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 payment align-items-center justify-content-between">
    ...
    <div class="row">
      <div class="col d-flex flex-row justify-content-between">
        ...
        <div class="box-2 footer-social">
          <a href="#" class="bg-sucess"><i class="fa fa-twitter"></i></a>
